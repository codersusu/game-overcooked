...
![An angled view of Bara's kitchen and animal café, with order ticket, score, timer and End chat button.](images/cover.png)
...
![Four approved capybara wardrobe concepts: male and female chef and customer.](images/capybara-concept.png)
...
![Whole and chopped tomato, cucumber, carrot and mushroom, alongside salad, soup and dishes.](images/food-models.png)
...
![A capybara chef working at a low chopping counter with a tomato.](images/chopping-animation.png)
...
![First Service after a salad delivery, with a seated capybara customer eating.](images/first-service.png)
...
![The Zigzag Café with two dividing rails, offset passages, worktops and animal diners.](images/zigzag-kitchen.png)
...
![First Service's picture tutorial showing chop, plate, serve and wash.](images/picture-guide.png)
...
![Live voice trailer frame with Bara discussing the actual score of 80 points and one delivered dish.](images/voice-guidance.jpg)
...
![Bara Kitchen live voice trailer cover.](images/voice-trailer.jpg)
...
|---|---|---|
| [cover.png](images/cover.png) | Gameplay screenshot | Recommended cover · actual Unity gameplay, with live chat active. |
| [capybara-concept.png](images/capybara-concept.png) | Concept art | Approved capybara wardrobe direction, based on the C1 proportions. |
| [cat-concept.png](images/cat-concept.png) | Concept art | Cat variants share the shape language while retaining a distinct face and silhouette. |
| [dog-concept.png](images/dog-concept.png) | Concept art | Dog variants extend the same visual standard to a third playable species. |
| [food-models.png](images/food-models.png) | Unity asset review | Reusable 3D food kit in Unity: four ingredients, two recipes and one serving vessel. |
| [chopping-animation.png](images/chopping-animation.png) | Animation review still | Animation review at paw-height worktops. Open the linked clip to inspect the movement. |
| [first-service.png](images/first-service.png) | Gameplay screenshot | The first completed salad starts service; the guest eats in the adjoining café. |
| [zigzag-kitchen.png](images/zigzag-kitchen.png) | Gameplay screenshot | Kitchen four combines prep, cooking and throwing routes across three work areas. |
| [fire-rescue.png](images/fire-rescue.png) | Gameplay screenshot | A diagonal camera keeps the pot and fire-fighting action visible beside the chef. |
| [picture-guide.png](images/picture-guide.png) | Gameplay screenshot | A short picture guide teaches the loop without filling service with text popups. |
| [voice-guidance.jpg](images/voice-guidance.jpg) | Edited trailer still | Real GPT-Live progress feedback. Subtitles and the heading were added for the trailer. |
| [gameplay-trailer.jpg](images/gameplay-trailer.jpg) | Promotional title art | Gameplay trailer · 48 seconds · actual Unity play footage. |
| [voice-trailer.jpg](images/voice-trailer.jpg) | Promotional title art | Voice trailer · 57 seconds · real replies, with synthetic player questions. |
| [icon.png](images/icon.png) | Generated game icon | The existing approved game icon; optional supporting artwork. |

All selected files are unchanged copies of the sources recorded in [media-manifest.json](media-manifest.json). The concept sheets and icon are generated art; gameplay screenshots show the implemented build. The cooking game and most captures predate the voice addition. No new game content or audio was generated for this submission package.
...
- The repository is public. Version 0.2.0 was published on 18 September 2026; its Web and Apple silicon Mac ZIPs and voice trailer are publicly available at https://github.com/codersusu/game-overcooked/releases/tag/v0.2.0. The form still uses the repository URL and local setup instructions because no public hosted game URL is provided.
