    ...
    static void Tick() {
        ...
        try {
            ...
            if(mode==3) {
                ...
                if(shot==1&&stage.playhead>11.3f){if(stage.hazard.state!=HeatState.Burning||stage.hazard.visual.flameParticles.particleCount==0)throw new Exception("Native particles missing");Capture("Burning");
